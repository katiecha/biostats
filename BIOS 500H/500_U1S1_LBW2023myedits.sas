...
footnote1 "produced by Katie Chai /home/u63543119/bios500H/Code_and_more/500_U1S1_LBWmyedits.sas"; 
...
libname bios500H "/home/u63543119/bios500H/Data"; *the path is case sensitive;
...
Proc univariate data=temp_girl;
	title6 "Here are some descriptive stats for GESTATIONAL AGE for the n=?? ???? in lbw dataset ";
		var gestage;
	run;  
	
data bios500h.perm_girl; set temp_girl; 
	run;
*Creates a permanent data set (perm_girl)  using temp_girl. 
